...
## Why choose a commercial theme? {#h-why-choose-a-commercial-theme.wp-block-heading}
...
### No child theme {#h-no-child-theme.wp-block-heading}
...
### As little CSS as possible {#h-as-little-css-as-possible.wp-block-heading}
...
### Performant {#h-performant.wp-block-heading}
...
### Portable {#h-portable.wp-block-heading}
...
### Customizable {#h-customizable.wp-block-heading}
...
## GeneratePress and Blocksy {#h-generatepress-and-blocksy.wp-block-heading}
...
### Reviewing GeneratePress {#h-reviewing-generatepress.wp-block-heading}<figure class="wp-block-image size-large">

<img loading="lazy" decoding="async" width="850" height="547" src="/images/2021/07/generatepress-850x547.png" alt="" class="wp-image-880" srcset="/images/2021/07/generatepress-850x547.png 850w, /images/2021/07/generatepress-400x258.png 400w, /images/2021/07/generatepress.png 1250w" sizes="(max-width: 850px) 100vw, 850px" /> </figure>

<div class="wp-block-columns alignfull has-text-color has-background is-layout-flex wp-container-core-columns-is-layout-1 wp-block-columns-is-layout-flex" style="background-color:#ffffff;color:#000000">
  <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
    <h3 class="wp-block-heading" id="h-pros" style="font-size:24px;line-height:1.3">
      <strong>Pros</strong>
    </h3>
  ...
  <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
    <h3 class="wp-block-heading" id="h-cons" style="font-size:24px;line-height:1.3">
      <strong>Cons</strong>
    </h3>
...
GeneratePress would have been the perfect theme for the way I've built this site for the last 10+ years. It gives your site a great start that simply needs to be tweaked with a combination of CSS and extra code in a child theme. In the end, though, I was simply not able to get to a design I liked without more code than I wanted to write. For example, while layouts were easy to change for a whole page, the layout of content items such as posts was pretty much fixed and not really what I was looking for. <figure class="wp-block-image size-large">

<img loading="lazy" decoding="async" width="850" height="671" src="/images/2021/07/generatepress-grid-850x671.jpg" alt="The default grid layout in GeneratePress" class="wp-image-881" srcset="/images/2021/07/generatepress-grid-850x671.jpg 850w, /images/2021/07/generatepress-grid-400x316.jpg 400w, /images/2021/07/generatepress-grid.jpg 1250w" sizes="(max-width: 850px) 100vw, 850px" /> <figcaption>The GeneratePress grid layout looks OK but there isn't a whole lot more customization I could do without additional code.</figcaption></figure>
...
### Blocksy Review {#h-blocksy-review.wp-block-heading}<figure class="wp-block-image size-large">

<img loading="lazy" decoding="async" width="850" height="547" src="/images/2021/07/blocksy-850x547.png" alt="" class="wp-image-882" srcset="/images/2021/07/blocksy-850x547.png 850w, /images/2021/07/blocksy-400x258.png 400w, /images/2021/07/blocksy.png 1250w" sizes="(max-width: 850px) 100vw, 850px" /> </figure>

<div class="wp-block-columns alignfull has-text-color has-background is-layout-flex wp-container-core-columns-is-layout-2 wp-block-columns-is-layout-flex" style="background-color:#ffffff;color:#000000">
  <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
    <h3 class="wp-block-heading" id="h-pros-1" style="font-size:24px;line-height:1.3">
      <strong>Pros</strong>
    </h3>
  ...
  <div class="wp-block-column is-layout-flow wp-block-column-is-layout-flow">
    <h3 class="wp-block-heading" id="h-cons-1" style="font-size:24px;line-height:1.3">
      <strong>Cons</strong>
    </h3>
...
I don't remember where I first heard about Blocksy but I can say it was not as highly recommended as GeneratePress. That said, from the moment I activated it I found it to be much easier to work with and contain far more options to customize it without the code that GeneratePress needed.<figure class="wp-block-image size-large">

<img loading="lazy" decoding="async" width="850" height="541" src="/images/2021/07/blocksy-blog-layout-850x541.jpg" alt="" class="wp-image-885" srcset="/images/2021/07/blocksy-blog-layout-850x541.jpg 850w, /images/2021/07/blocksy-blog-layout-400x255.jpg 400w, /images/2021/07/blocksy-blog-layout.jpg 1265w" sizes="(max-width: 850px) 100vw, 850px" /> <figcaption>Blocksy's customizer is where the theme really shines. Look at all the elements you can tweak on the left!</figcaption></figure>
...
What I don't like about Blocksy is its use of Freemius, an invasive service marketed to WordPress developers to help sell their plugins or themes. I don't mind paying for a product I'll use but I do not like seeing follow-up surveys and other garbage in my email from such services after I do so. <figure class="wp-block-image size-large">

<img loading="lazy" decoding="async" width="850" height="541" src="/images/2021/07/blocksy-onboarding-2-850x541.png" alt="" class="wp-image-884" srcset="/images/2021/07/blocksy-onboarding-2-850x541.png 850w, /images/2021/07/blocksy-onboarding-2-400x255.png 400w, /images/2021/07/blocksy-onboarding-2.png 1265w" sizes="(max-width: 850px) 100vw, 850px" /> <figcaption>Blocksy's onboarding screen where it wants to give your data to a third party.</figcaption></figure>
...
## Blocksy vs GeneratePress: Which theme is right for you {#h-blocksy-vs-generatepress-which-theme-is-right-for-you.wp-block-heading}
